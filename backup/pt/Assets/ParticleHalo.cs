...
public class ParticleHalo : MonoBehaviour
{
    ...
    void Update()
    {
        for (int i = 0; i < particleNum; i++)
        {
            ...
            particleArr[i].color = colorGradient.Evaluate(StatusArr[i].angle * 10000); // 根据粒子的angle，给粒子赋予不同的透明度（颜色），使某一些角度上的例子暗一些
        }
